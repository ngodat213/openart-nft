...
import 'widget/card_currentbid.dart';

class DetailCurrentBidScreen extends StatelessWidget {
  const DetailCurrentBidScreen({super.key});
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            FooterWidget(size: size, top: 119)
          ],
        ),
      )),
    );
